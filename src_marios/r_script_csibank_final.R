...
# perform Mann-Whitney between 2 independent populations
...
loy_sub <- subset_data$loy_avg
loy_sub[loy_sub == -Inf] <- NA

wilcox.test(loy_sub ~ Age, data=subset_data)

# Wilcoxon rank sum test with continuity correction
#
# data:  loy_sub by Age
# W = 12697, p-value = 0.4373
# alternative hypothesis: true location shift is not equal to 0


# -------------------------------------------------------

wilcox.test(loy_sub ~ Gender, data=subset_data)


# Wilcoxon rank sum test with continuity correction
# 
# data:  loy_sub by Gender
# W = 35687, p-value = 0.1065
# alternative hypothesis: true location shift is not equal to 0
...
wilcox.test(loy_sub ~ Region, data=subset_data)

# Wilcoxon rank sum test with continuity correction
# 
# data:  loy_sub by Region
# W = 156021, p-value = 0.1752
# alternative hypothesis: true location shift is not equal to 0
...
wilcox.test(loy_sub ~ Occupation, data=subset_data)

# Wilcoxon rank sum test with continuity correction
# 
# data:  loy_sub by Occupation
# W = 53453, p-value = 0.2285
# alternative hypothesis: true location shift is not equal to 0


# -------------------------------------------------------

# Mann-Whitney for Manager - MediumEmploy in relation to loyalty
...
# 
# data:  loy_sub by Occupation
# W = 21298, p-value = 0.003939
# alternative hypothesis: true location shift is not equal to 0

# -------------------------------------------------------

# Mann-Whitney for Unfinished - Elementary in relation to loyalty

subset_data <- subset(csibank, Education %in% c("Unfinished", "Elementary"))
loy_sub <- subset_data$loy_avg
loy_sub[loy_sub == -Inf] <- NA

wilcox.test(loy_sub ~ Education, data=subset_data)

# Wilcoxon rank sum test with continuity correction
# 
# data:  loy_sub by Education
# W = 6635, p-value = 0.4138
# alternative hypothesis: true location shift is not equal to 0

# -------------------------------------------------------

# Mann-Whitney for Unfinished - Graduated in relation to loyalty
...
# 
# Coefficients:
#    Εstimate Std. Error t value Pr(>|t|)    
...
rf_all <- randomForest(loy_avg ~ . , data = train_set)

# Print Metric results
print(calculate_error_metrics(rf_all, test_set, actuals))
